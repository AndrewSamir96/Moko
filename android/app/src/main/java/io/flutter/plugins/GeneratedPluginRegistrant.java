...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.ravi.files_scanner_android.FilesScannerAndroidPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin files_scanner_android, com.ravi.files_scanner_android.FilesScannerAndroidPlugin", e);
    }
    try {
